...
// NOTE: "Training status" (single-select → profile.trainingStatus) still sits
// between Pace and Energy reality in the real flow; not yet built, so Pace
// currently advances straight to Energy reality. (The splash + sign-in are
// handled separately, before onboarding — see AppContent's routing.)
type OnboardingStep =
  | "welcome"
  | "glp"
  | "medicationDetails"
...
function AppContent() {
  ...
  function renderOnboarding() {
    switch (step) {
    case "welcome":
      return <WelcomeScreen onStart={() => setStep("glp")} />;
    case "glp":
      return (
        <GlpScreen
          onBack={() => setStep("welcome")}
          onAnswer={(hasMedication) => setStep(hasMedication ? "medicationDetails" : "journey")}
        />
      );
    case "medicationDetails":
      return <MedicationDetailsScreen onBack={() => setStep("glp")} onContinue={() => setStep("shotDay")} />;
    case "shotDay":
      return <ShotDayScreen onBack={() => setStep("medicationDetails")} onContinue={() => setStep("journey")} />;
    case "journey":
      return <JourneyScreen onBack={() => setStep("glp")} onAnswer={() => setStep("fear")} />;
    case "fear":
      return <FearScreen onBack={() => setStep("journey")} onAnswer={() => setStep("basics")} />;
    case "basics":
      return <BasicsScreen onBack={() => setStep("fear")} onContinue={() => setStep("heightWeight")} />;
    case "heightWeight":
      return <HeightWeightScreen onBack={() => setStep("basics")} onContinue={() => setStep("trainingStatus")} />;
    case "trainingStatus":
      return <TrainingStatusScreen onBack={() => setStep("heightWeight")} onAnswer={() => setStep("goalWeight")} />;
    case "goalWeight":
      return <GoalWeightScreen onBack={() => setStep("trainingStatus")} onContinue={() => setStep("pace")} />;
    case "pace":
      return <PaceScreen onBack={() => setStep("goalWeight")} onContinue={() => setStep("energyReality")} />;
    case "energyReality":
      return <EnergyRealityScreen onBack={() => setStep("pace")} onContinue={() => setStep("crafting")} />;
    case "crafting":
      return <CraftingPlanScreen onBack={() => setStep("energyReality")} onDone={() => setStep("paywall")} />;
    case "paywall":
    default:
