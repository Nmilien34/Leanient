...
import { FOOD_CATALOG, FOOD_CATEGORY_LABELS, popularFoods, searchFoods, type FoodPreset } from "./foodCatalog";
        ...
        <ModalSafeArea style={styles.safe} edges={["top", "bottom"]}>
          ...
          <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            ...
            <TextInput
              ...
              placeholder={form.items.length > 0 ? "Add another food" : "Search foods"}
